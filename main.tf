...
module "tf-azure-crown1" {
  source = "app.terraform.io/burkey/workspace/tfe"
  version = "0.0.20" 
  providers = {
    github = github.personal
  }
  repository_name = "tf-azure-crown1"
  create_repo = true
...
module "tf-azure-crown" {
  source = "app.terraform.io/burkey/workspace/tfe"
  version = "0.0.20" 
  providers = {
    github = github.personal
  }
  repository_name = "tf-azure-crown"
  create_repo = true
  repository_private = false
  oauth_token_id = var.oauth_token_id
  tf_var = merge({
...
module "tf-azure-bigdata" {
  source = "app.terraform.io/burkey/workspace/tfe"
  version = "0.0.20" 
  providers = {
    github = github.personal
  }
  repository_name = "tf-azure-bigdata"
  create_repo = true
  repository_private = false
  oauth_token_id = var.oauth_token_id
  tf_var = merge({
